...
class SymbolTable {
    ...
    public boolean addClass(String id, String parent) {
        if(containsClass(id))
            ...
            classCount += 1;
            hashtable.get(id).idRef = classCount;
        }
        return true;
    }
...
class Class {
    ...
    public boolean addMethod(String id, Type type) {
        if (containsMethod(id))
            ...
            declCount += 1;
            methods.get(id).idRef = concIntegers(idRef, declCount);
            return true;
        }
    }
    ...
    public boolean addVar(String id, Type type) {
        if (fields.containsKey(id))
            ...
            declCount += 1;
            fields.get(id).idRef = concIntegers(idRef, declCount);
            return true;
        }
    }
    ...
    public int concIntegers(int i1, int i2){
...
class Method {
    ...
    public boolean addParam(String id, Type type) {
        if (containsParam(id))
            ...
            declCount += 1;
            params.lastElement().idRef = concIntegers(idRef, declCount);
            return true;
        }
    }
    ...
    // Return false if there is a name conflict
    public boolean addVar(String id, Type type) {
        if (vars.containsKey(id) || containsParam(id))
            return false;
        else {
            vars.put(id, new Variable(id, type));
            declCount += 1;
            vars.get(id).idRef = concIntegers(idRef, declCount);
            return true;
        }
    }
