...
public class Task3Visitor implements Visitor {
  ...
  public void definePower(){
        System.out.println("  static int power(int l, int r){\n    int i = 0, res = 1;\n    while (i < r){\n      res = res * l;\n      i = i + 1;\n    }\n    return res;\n  }");
  }
  // Identifier i1,i2;
  // Statement s;
  ...
  // Exp e1,e2;
  public void visit(IntegerDivision n) {
    System.out.print("(");
    n.e1.accept(this);
    System.out.print(" / ");
    n.e2.accept(this);
  ...
  // Exp e1,e2;
  public void visit(Exponential n) {
